...
<section class="hservices">
 ...
 <?php if($offering_sub ->have_posts()) : while($offering_sub ->have_posts()) :$offering_sub ->the_post();?>
    <div class="hservices__item" style="background-image: linear-gradient(rgba(0,0,0,0.8), rgba(0,0,0,0.8)), url(<?php echo get_field('other_offering_background')['url']?>) ">
...
<section class="testimonial">
    ...
    <div class="container">
        ...
        <div class="testimonial__wrapper" >
            <div class="testimonial__slider" style="background-image: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.65)), url(<?php echo get_field('testimonial_background')['url']?>) ">
